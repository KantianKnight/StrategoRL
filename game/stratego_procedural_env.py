...
from stratego_env.game.stratego_procedural_impl import INT_DTYPE_NP, StateLayers, SP, \
    ...
    _get_spatial_action_size, _get_heuristic_rewards_from_move
...
class StrategoProceduralEnv(object):
    ...
    # added this
    def get_heuristic_rewards_from_move(self, state: np.ndarray, player, action_index, action_size):
        return _get_heuristic_rewards_from_move(state=state, player=INT_DTYPE_NP(player),
                                                action_index=INT_DTYPE_NP(action_index),
                                                action_size=INT_DTYPE_NP(action_size))
